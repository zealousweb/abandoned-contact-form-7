<?php
/**
 * Plugin Name: Abandoned Contact Form 7 Pro
 * Plugin URL: https://wordpress.org/plugin-url/
 * Description: Abandoned Contact Form 7 pro provides an ability to track the data from Contact Form 7 even if the user does not submit the form.
 * Version: 1.1
 * Author: ZealousWeb
...
if ( !defined( 'CF7AF_VERSION' ) ) {
	define( 'CF7AF_VERSION', '1.1' ); // Version of plugin
}
